(function(t) {
    function e(e) {
        for (var s, o, a = e[0], c = e[1], l = e[2], d = 0, h = []; d < a.length; d++) o = a[d], Object.prototype.hasOwnProperty.call(n, o) && n[o] && h.push(n[o][0]), n[o] = 0;
    ...
    c.e = function(t) {
        ...
        o[t] ? e.push(o[t]) : 0 !== o[t] && i[t] && e.push(o[t] = new Promise((function(e, i) {
            for (var s = "css/" + ({
                ...
                if ("stylesheet" === l.rel && (d === s || d === n)) return e()
            }
            var h = document.getElementsByTagName("style");
            for (a = 0; a < h.length; a++) {
                l = h[a], d = l.getAttribute("data-href");
                if (d === s || d === n) return e()
            }
            ...
            u.rel = "stylesheet", u.type = "text/css", u.onload = e, u.onerror = function(e) {
                ...
                r.code = "CSS_CHUNK_LOAD_FAILED", r.request = s, delete o[t], u.parentNode.removeChild(u), i(r)
            }, u.href = n;
        ...
        if (0 !== s)
            if (s) e.push(s[2]);
                ...
                d.charset = "utf-8", d.timeout = 120, c.nc && d.setAttribute("nonce", c.nc), d.src = a(t);
                var h = new Error;
                l = function(e) {
                    ...
                    if (0 !== i) {
                        if (i) {
                            ...
                            h.message = "Loading chunk " + t + " failed.\n(" + s + ": " + o + ")", h.name = "ChunkLoadError", h.type = s, h.request = o, i[1](h)
                        }
                        n[t] = void 0
                    }
                };
    ...
    }, c.m = t, c.c = s, c.d = function(t, e, i) {
        ...
        if (c.r(i), Object.defineProperty(i, "default", {
            ...
            for (var s in t) c.d(i, s, function(e) {
                return t[e]
            }.bind(null, s));
        return i
    }, c.n = function(t) {
    ...
    "025e": function(t, e, i) {
        ...
        const o = window.devicePixelRatio >= 2 ? 2 : 1,
            ...
            h = t => new Promise((e, i) => {
                const s = new Image;
                s.addEventListener("load", t => e(s)), s.addEventListener("error", () => {
            ...
            p = () => new Promise((t, e) => {
                ...
                i ? i.getCurrentPosition(e => t(e.coords), t => e(s[Math.min(t.code, s.length - 1)])) : (console.log("window.navigator.geolocation Not Supported"), e(s[0]))
            }),
            m = (t, e, i, s) => {
    ...
    "08c1": function(t, e, i) {
        ...
        var s = function() {
            ...
            r = {
                ...
                methods: {
                    toggle(t) {
                        if (t.srcElement.hasAttribute("data-popper-ignore")) return;
                        const e = t.currentTarget;
                        this.isShown ? this.dismiss() : this.present(e)
                    },
                    dismiss() {
                        this.isVisible = !1, setTimeout(() => {
                            this.popper && (this.popper.destroy(), this.popper = null), this.isShown = !1, this.$emit("dismiss"), document.removeEventListener("click", this.documentDidClick)
                        }, 300)
                    },
                    present(t) {
                        this.isShown = !0, this.$emit("present"), requestAnimationFrame(() => this.create(t))
                    },
                    create(t) {
                        ...
                        e.modifiers = [...e.modifiers, {
                            ...
                            phase: "main",
                            fn: this.autoDismiss
                        }], this.popper = Object(n["a"])(t, this.$refs.popover, e), this.isVisible = !0, document.addEventListener("click", this.documentDidClick)
                    },
                    documentDidClick(t) {
        ...
        var v = {
                ...
                computed: {
                    timeAgo() {
                        ...
                        return navigator.language.includes("zh") ? (i("a471"), t.locale("zh-cn").fromNow()) : t.fromNow()
                    }
                },
                methods: {
                    init() {
                        this.updateHeightProperty(), window.addEventListener("resize", this.updateHeightProperty), document.getElementById("container").addEventListener("scroll", this.scrollListener), requestAnimationFrame(() => this.scrollToTarget(this.target))
                    },
                    deinit() {
            ...
            w = v,
            b = (i("7642"), Object(l["a"])(w, s, o, !1, null, "54f93a16", null));
        e["a"] = b.exports
    },
    "1c4a": function(t, e, i) {
        "use strict";
    ...
    3849: function(t, e, i) {
        ...
        var s = function() {
                ...
                methods: {
                    ...
                    setSize() {
                        requestAnimationFrame(() => {
                            this.viewWidth = Object(p["i"])(), this.viewHeight = window.innerHeight - this.padding
                        })
                    }
                },
                computed: {
            ...
            f = m,
            g = (i("da23"), Object(l["a"])(f, s, o, !1, null, "0b32190e", null));
        e["a"] = g.exports
    },
    "38de": function(t, e, i) {},
    4305: function(t, e, i) {
    ...
    "48fb": function(t, e, i) {
        ...
        const n = "https://stat.ms.dandyweng.com",
            ...
            h = t => {
                ...
                return location.search && window.history.replaceState(null, "", location.href.replace(location.search, "")), e && (s["client_tag"] = e), i ? (s["client_id"] = i, navigator.sendBeacon ? navigator.sendBeacon(r, JSON.stringify(s)) : o.a.post(r, s)) : o.a.post(r, s).then(t => a.session_token = t.data)
            };
        e["a"] = {
            visited(t) {
                h({
    ...
    "56d7": function(t, e, i) {
        ...
        var s = i("2b0e"),
            ...
            _ = {
                ...
                methods: {
                    ...
                    select(t) {
                        t != this.current && (this.current = t, r.$emit("viewStyleDidChange", t), "map" != t && localStorage.setItem("view-selection", t))
                    }
                }
            },
            x = _,
            C = (i("bf2b"), Object(g["a"])(x, b, y, !1, null, "407ef784", null)),
            P = C.exports,
            S = {
                name: "Header",
                components: {
            ...
            M = S,
            O = (i("472b"), Object(g["a"])(M, a, c, !1, null, "6059c918", null)),
            j = O.exports,
            k = {
                name: "App",
                metaInfo: {
            ...
            I = k,
            $ = (i("4809"), Object(g["a"])(I, o, n, !1, null, null, null)),
            D = $.exports,
            L = i("8c4f"),
            V = function() {
                var t = this,
        ...
        class q {
            constructor(t, e) {
                Object.assign(this, t), this.userLocale = e
            }
            get name() {
            ...
            getName(t) {
                ...
                return e.suffix && e.tags && e.tags.includes("suffix-is-mandatory") && (i += this.userLocale.suffixSeparator + e.suffix), i
            }
        }
        class B {
            constructor(t, e, i, s) {
                Object(E["a"])(this, "getByID", t => this.path.filter(e => e.id == t)[0] || !1), Object(E["a"])(this, "getByTag", t => this.path.filter(e => e.tags.includes(t))[0] || !1), this.id = e, this.contextID = i || s.locationRootContextID, this.userLocale = s, this.path = this.getPathLocation(t), this.isAvailable = void 0 !== this.path
            }
            get displayName() {
            ...
            select(t) {
                ...
                const i = this.path,
                    ...
                    c = i[n + 3],
                    l = [s ? r : o];
                if (r && r.tags.includes("prominent") && !s) l.push(r);
                else if (c && (c.tags.includes("prominent") || a.tags.includes("pass"))) l.push(c);
                else {
                    const t = s ? null : r;
                    l.push(a || t)
                }
            ...
            getPath(t) {
                let e;
                return t.id === this.id ? [t] : ((t.nodes || []).some(t => e = this.getPath(t)), e && [t, ...e].filter(t => t.id))
            }
            getPathLocation(t) {
        ...
        class G {
            constructor(t) {
                Object.assign(this, t), this.colors = t.colors.split("-"), this.files = this.files.map(t => new U(t))
            }
            setEquipments(t) {
        ...
        class J {
            ...
            fetchPhoto(t) {
                ...
                return Object(N["a"])((function*() {
                    ...
                    return e.set(i.data["data"]), e.newPhoto(e.photo)
                }))()
            }
            getPhoto(t) {
        ...
        class Q {
            constructor() {
                Object(E["a"])(this, "queue", []), this.fetch()
            }
            set(t) {
                Object.assign(this, t), this.userLocale = new K(localStorage.getItem("locale")), this.queue.forEach(t => {
            ...
            fetch(t) {
                ...
                return Object(N["a"])((function*() {
                    ...
                    if (s && !t) return void e.set(JSON.parse(s));
                    if (e.isFetchingLocationData) return;
                    e.isFetchingLocationData = !0;
                    const o = yield z();
                    t !== o.data._version ? (localStorage.setItem(i, JSON.stringify(o.data)), e.set(o.data)) : console.warn("Unable to fetch a valid LocationData. Wait for CDN propagation and try again."), e.isFetchingLocationData = !1
                }))()
            }
            setLocation(t) {
                const e = this.data;
                if (!e) return void this.queue.push(t);
                const i = new W(e, t.location_id, null, this.userLocale);
                if (i.isAvailable) return t.locationContext = i, t;
            ...
            getRepresentative(t, e) {
                ...
                for (let o = 0; o < s.length; o++) {
                    const t = s[o];
                    if (!(1 == t.length && o < s.length - 1)) return t.length > e ? s[o - 1] : t
                }
            }
        }
        class K {
        ...
        var Y = new J,
            ...
            ot = st,
            nt = (i("f63f"), Object(g["a"])(ot, tt, et, !1, null, "62c6daa4", null)),
            rt = nt.exports,
            at = i("58f1"),
            ct = i.n(at),
            lt = i("e16c"),
            ...
            ut = ht,
            pt = (i("aca5"), Object(g["a"])(ut, X, Z, !1, null, "801df05a", null)),
            mt = pt.exports,
            ft = function() {
                var t = this,
                    e = t._self._c;
            ...
            xt = _t,
            Ct = (i("d581"), Object(g["a"])(xt, bt, yt, !1, null, "35227aba", null)),
            Pt = Ct.exports,
            St = i("3849"),
            Mt = {
                name: "Feed",
                ...
                methods: {
                    ...
                    photoInView(t, e) {
                        if (t) {
                            ...
                            setTimeout(() => {
                                e === this.photoInViewID && (vt["a"].seen("photo", e, "feed"), this.$log(`Seen photo ${e} @ feed`), this.seen.push(e))
                            }, 500)
                        }
                    }
                }
            ...
            Dt = {
                ...
                watch: {
                    "inViewport.now" (t) {
                        t && !this.seen && (this.seen = !0, vt["a"].seen("footer"))
                    }
                }
            },
            Lt = Dt,
            Vt = (i("1ca5"), Object(g["a"])(Lt, It, $t, !1, null, "17d64fff", null)),
            Tt = Vt.exports,
            Nt = function() {
                var t = this,
                    e = t._self._c;
            ...
            Ht = At,
            Ft = (i("e7df"), Object(g["a"])(Ht, Nt, Et, !1, null, "7091de0a", null)),
            Rt = Ft.exports,
            zt = function() {
                var t = this,
                    e = t._self._c;
            ...
            Wt = {
                ...
                methods: {
                    ...
                    select(t) {
                        t != this.current && (this.current = t, r.$emit("columnDidChange", t), localStorage.setItem("column-selection", t))
                    }
                }
            },
            Gt = Wt,
            Ut = (i("d649"), Object(g["a"])(Gt, zt, qt, !1, null, "6281e6b6", null)),
            Jt = Ut.exports,
            Qt = i("a513");
        ...
        var Xt = {
                ...
                methods: {
                    init() {
                        this.column = Bt["a"].find(t => t.id === localStorage.getItem("column-selection")) || this.column, this.style = this.$route.params.style || localStorage.getItem("view-selection") || this.style, this.hasMore = !0, this.fetched = !1, r.$on("columnDidChange", t => this.updateColumn(t)), r.$on("viewStyleDidChange", t => this.updateStyle(t))
                    },
                    deinit() {
                        r.$off("columnDidChange", t => this.updateColumn(t)), r.$off("viewStyleDidChange", t => this.updateStyle(t))
                    },
                    fetch() {
                        var t = this;
                        return Object(N["a"])((function*() {
                            try {
                                yield Y.fetch(), t.updateData()
                            } catch (e) {
                                console.error(e)
                            }
                        }))()
                    ...
                    updateData() {
                        ...
                        return Object(N["a"])((function*() {
                            ...
                            t.photos = [...t.photos, ...e], t.fetched = !0, t.hasMore = t.photos.length < Y.photos.length
                        }))()
                    },
                    requestUserLocation() {
                        var t = this;
                        return Object(N["a"])((function*() {
                            try {
                                const t = yield Object(p["f"])(), e = t.latitude, i = t.longitude, s = JSON.stringify({
                                    latitude: e,
                                    longitude: i
                                });
                                return sessionStorage.setItem("coordinates", s), s
                            } catch (e) {
                                return t.fetched = !0, t.hasMore = !1, t.errorMessage = "exceptions.geo." + e, null
                            }
                        }))()
                    },
                    carouselDidToggle() {
                    ...
                    updateColumn(t) {
                        this.column = Bt["a"].find(e => e.id === t), this.fetched = !1, this.photos = [], this.currentPage = 1, this.errorMessage = null, this.updateData(), "essential" === t ? this.$router.push({
                            path: "/",
                            replace: !0
                        }) : this.$router.push({
                            path: t,
            ...
            Zt = Xt,
            te = (i("4305"), Object(g["a"])(Zt, V, T, !1, null, "95420844", null)),
            ee = te.exports,
            ie = function() {
                var t = this,
                    e = t._self._c;
            ...
            se = [];
        const oe = t => t + "px",
            ne = (t, e) => i => i.map(e => (e._distance = Object(p["d"])(t.coordinates.latitude, t.coordinates.longitude, e.latitude, e.longitude), e)).sort((t, e) => t._distance - e._distance).filter(i => i._distance < t.kmpp * e);
        var re = {
                name: "Maps",
                mixins: [it["a"]],
                components: {
                ...
                methods: {
                    ...
                    showPhotos(t, e) {
                        this.showPopover = !0, this.marker = e, this.selectedPhotos = t, requestAnimationFrame(() => this.setPopover())
                    },
                    hidePhotos() {
                    ...
                    mapDidClick(t) {
                        ...
                        i.length > 0 ? (this.showPhotos(i, t.marker), this.selectedGeoDescription = Y.getGeoDescription(e, 4, this.$t("list-separators")), vt["a"].selected(t.coordinates, t.kmpp * this.cursorRadius)) : this.hidePhotos()
                    },
                    mapDidHover(t) {
                        ...
                        o !== this.lastHoverPosition && (this.selectionHasPhotos = 1 === Y.nextBatch(1, 1, ne(t, this.cursorRadius)).length, this.lastHoverPosition = o)
                    },
                    mapDidLoad() {
                        this.isMapLoaded = !0
                    },
            ...
            ae = re,
            ce = (i("5f46"), Object(g["a"])(ae, ie, se, !1, null, "9fb1d580", null)),
            le = ce.exports,
            de = function() {
                var t = this,
                    e = t._self._c;
        ...
        var pe = {
                ...
                methods: {
                    ...
                    fetch() {
                        ...
                        return Object(N["a"])((function*() {
                            try {
                                t.photo = yield Y.fetchPhoto(ue(t.$route.params.id)), vt["a"].seen(t.photo.id, "singular")
                            } catch (e) {
                                t.handleException(e)
                            } finally {
                                t.fetched = !0, requestAnimationFrame(() => {
                                    window.scrollTo(0, 0)
                                })
                            }
                        }))()
                    ...
                    fetchColumns() {
                        ...
                        return Object(N["a"])((function*() {
                            try {
                                yield Y.fetch(), t.updateColumnData(), t.columnLoaded = !0
                            } catch (e) {
                                console.error(e)
                            }
                        }))()
            ...
            me = pe,
            fe = (i("47f3"), Object(g["a"])(me, de, he, !1, null, "25a289d0", null)),
            ge = fe.exports;
        s["a"].use(L["a"]);
        var ve = new L["a"]({
                mode: "history",
            ...
            we = i("a925"),
            be = i("58ca");
        s["a"].config.productionTip = !1, s["a"].prototype.$libraryURL = "//library.cdn.camartsphotography.com", s["a"].prototype.$log = t => {
            0
        }, s["a"].use(we["a"]), s["a"].use(be["a"]);
        const ye = {
                "en-US": i("4a03"),
        ...
        document.documentElement.setAttribute("lang", _e.locale), localStorage.setItem("locale", _e.locale), new s["a"]({
            el: "#app",
            router: ve,
            i18n: _e,
            components: {
    ...
    a9fb: function(t, e, i) {
        ...
        var s = function() {
            ...
            m = {
                ...
                methods: {
                    showPopover(t, e) {
                        ...
                        i && (this.metaPanelTarget = e, i.update(t.target))
                    },
                    dismissPopover() {
                        const t = this.$refs.popover;
                        t && t.dismiss()
            ...
            f = m,
            g = (i("dbbc"), Object(d["a"])(f, s, o, !1, null, "9c46fcc4", null));
        e["a"] = g.exports
    },
    aa17: function(t, e, i) {
